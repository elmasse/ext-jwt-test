...
folder are mapped to the application's root namespace, 'Bookmarks'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Bookmarks' in the same way
as `"Bookmarks/sass/src"`.
